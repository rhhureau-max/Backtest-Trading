...
FVG Definition:
- Bullish FVG: Low of candle 3 (8:31) > High of candle 1 (8:29)
- Bearish FVG: High of candle 3 (8:31) < Low of candle 1 (8:29)
"""
...
def analyze_fvg_at_830(df, year):
    """
    Analyze FVG occurrences at 8:30 AM for a given year
    ...
    # For each 8:30 candle, check for FVG
...
def main():
    ...
    print("=" * 80)
    print("FVG ANALYSIS AT 8:30 AM CANDLE (2018-2025)")
    print("=" * 80)
    print()
    print("Fair Value Gap (FVG) Definition:")
    print("  - Bullish FVG: Low of 8:31 candle > High of 8:29 candle")
    print("  - Bearish FVG: High of 8:31 candle < Low of 8:29 candle")
    print()
    print("=" * 80)
    print()
    ...
    if results:
        print("=" * 80)
        print("SUMMARY - FVG AT 8:30 AM CANDLE")
        print("=" * 80)
        print()
        ...
        with open('fvg_analysis_830.txt', 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("FVG ANALYSIS AT 8:30 AM CANDLE (2018-2025)\n")
            f.write("=" * 80 + "\n\n")
            f.write(f"Analysis Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n")
            
            f.write("Fair Value Gap (FVG) Definition:\n")
            f.write("  - Bullish FVG: Low of 8:31 candle > High of 8:29 candle\n")
            f.write("  - Bearish FVG: High of 8:31 candle < Low of 8:29 candle\n\n")
            
            f.write("SUMMARY - FVG AT 8:30 AM CANDLE\n")
            f.write("=" * 80 + "\n\n")
        ...
        print(f"Results saved to 'fvg_analysis_830.txt'")
    else:
