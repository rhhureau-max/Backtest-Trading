...
FVG Definition:
- Bullish FVG: Low of candle 3 (8:35) > High of candle 1 (8:25)
- Bearish FVG: High of candle 3 (8:35) < Low of candle 1 (8:25)
"""
...
def analyze_fvg_at_830(df, year):
    """
    Analyze FVG occurrences at 8:30 AM for a given year (5-minute candles)
    ...
    # For each 8:30 candle, check for FVG with 8:25 and 8:35 candles
    for idx in indices_830:
        ...
        # Validate that adjacent candles are actually 8:25 and 8:35
...
def main():
    ...
    print("=" * 80)
    print("FVG ANALYSIS AT 8:30 AM CANDLE - 5-MINUTE DATA (2018-2025)")
    print("=" * 80)
    print()
    print("Fair Value Gap (FVG) Definition:")
    print("  - Bullish FVG: Low of 8:35 candle > High of 8:25 candle")
    print("  - Bearish FVG: High of 8:35 candle < Low of 8:25 candle")
    print()
    print("=" * 80)
    print()
    ...
    # Analyze each year
    for year in years:
        # Try CSV first (5m data is in CSV format)
    ...
    if results:
        print("=" * 80)
        print("SUMMARY - FVG AT 8:30 AM CANDLE (5-MINUTE DATA)")
        print("=" * 80)
        print()
        ...
        with open('fvg_analysis_5m.txt', 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("FVG ANALYSIS AT 8:30 AM CANDLE - 5-MINUTE DATA (2018-2025)\n")
            f.write("=" * 80 + "\n\n")
            f.write(f"Analysis Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n")
            
            f.write("Fair Value Gap (FVG) Definition:\n")
            f.write("  - Bullish FVG: Low of 8:35 candle > High of 8:25 candle\n")
            f.write("  - Bearish FVG: High of 8:35 candle < Low of 8:25 candle\n\n")
            
            f.write("SUMMARY - FVG AT 8:30 AM CANDLE (5-MINUTE DATA)\n")
            f.write("=" * 80 + "\n\n")
        ...
        print(f"Results saved to 'fvg_analysis_5m.txt'")
    else:
