...
def analyze_fvg_quality_at_830(df, year):
    """
    Analyze FVG quality at 8:30 AM for a given year (15-minute candles)
    ...
    for idx in indices_830:
        ...
        # Get the three candles for FVG detection (8:15, 8:30, 8:45)
        ...
        # Check for FVG
        is_bullish_fvg = low_845 > high_815
        is_bearish_fvg = high_845 < low_815
        ...
        if is_bullish_fvg:
            # Bullish FVG zone: between high_815 and low_845
            fvg_low = high_815
            fvg_high = low_845
            ...
            # Bearish FVG zone: between low_815 and high_845
            fvg_low = high_845
            fvg_high = low_815
...
def main():
    ...
    print("=" * 80)
    print("FVG QUALITY ANALYSIS AT 8:30 AM - 15-MINUTE DATA (2018-2025)")
    print("=" * 80)
    print()
    ...
    if results:
        print("=" * 80)
        print("SUMMARY - FVG QUALITY AT 8:30 AM (15-MINUTE DATA)")
        print("=" * 80)
        print()
        ...
        with open('fvg_quality_analysis_15m.txt', 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("FVG QUALITY ANALYSIS AT 8:30 AM - 15-MINUTE DATA (2018-2025)\n")
            f.write("=" * 80 + "\n\n")
        ...
        print(f"Results saved to 'fvg_quality_analysis_15m.txt'")
    else:
