#!/usr/bin/env python3
"""
Liste complète de tous les FVG en 1 minute pour 2025

Ce script détecte tous les Fair Value Gaps dans les données 1 minute de 2025.
"""
...
def main():
    """Fonction principale pour lister tous les FVGs 1m en 2025."""
    print("=" * 100)
    print("Liste complète des FVG - 1 minute - Année 2025")
    print("=" * 100)
    ...
    print("=" * 100)
    print(f"\nPour sauvegarder dans un fichier: python3 {__file__} > fvg_1m_2025_complet.txt")
