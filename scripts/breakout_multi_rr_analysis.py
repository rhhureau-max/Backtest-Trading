#!/usr/bin/env python3
"""
Breakout Strategy Analysis Script (Multiple RR)

This script analyzes a breakout strategy based on the 8:30 candle with multiple RR ratios:
...
- Take Profit: Variable based on RR (1.5, 2.0, 2.5)
...
def main():
    ...
    print("=" * 100)
    print("ANALYSE DE LA STRATÉGIE BREAKOUT 8H30 - MULTI RR (1.5, 2.0, 2.5)")
    print("=" * 100)
    print("\nConditions:")
    ...
    print("  - Take Profit: Variable selon le RR (1.5x, 2x, 2.5x le SL)")
    print("=" * 100)
    ...
    print(f"\n{'Timeframe':<12} | {'RR 1.5':^20} | {'RR 2.0':^20} | {'RR 2.5':^20}")
    print("-" * 80)
