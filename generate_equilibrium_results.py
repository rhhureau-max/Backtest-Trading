...
def generate_markdown(all_results):
    ...
    md_content.append("")
    md_content.append("### Gestion du Risque - NOUVELLE APPROCHE")
    md_content.append("- **Stop Loss:** Placé à l'extrémité du swing")
    md_content.append("  - LONG: SL = Asia_Low")
    md_content.append("  - SHORT: SL = Asia_High")
